...
export default function HeroSection() {
  ...
  return (
    <section className={`${isDarkMode ? "bg-black text-white" : "bg-gray-50 text-black"} min-h-screen`}>
      {/* Navigation Header */}
      <nav className={`${isDarkMode ? "bg-[#131313] text-white" : "bg-white text-black"} flex items-center justify-between px-8 lg:px-16 py-6 shadow-sm`}>
        ...
        <div className="hidden md:flex items-center space-x-8 font-poppins">
          <Link to="/solution" className="hover:text-primary transition-colors font-medium">
            Solution
          </Link>
          <Link to="/pricing" className="hover:text-primary transition-colors font-medium">
            Pricing
          </Link>
          <Link to="/docs" className="hover:text-primary transition-colors font-medium">
            Docs
          </Link>
        ...
        <div className="flex items-center space-x-4 font-poppins">
          <Link to="/signin" className="hover:text-primary transition-colors font-medium">
            Sign In
          </Link>
          <Link to="/signup" className="px-6 py-2 rounded-lg transition-colors font-medium border border-current">
            Sign Up
          </Link>
