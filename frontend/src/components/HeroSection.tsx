    ...
    <section className={`${
      ...
      <div className="max-w-6xl mx-auto px-8 lg:px-16 pt-20 pb-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl max-w-2xl mx-auto leading-relaxed mb-8 font-jost ${
          ...
          <Link to="/dashboard">
          <button className={`px-8 py-3 rounded-lg transition-colors font-medium text-lg ${
            isDarkMode 
        ...
        <div className={`relative rounded-2xl shadow-lg p-12 mb-20 font-poppins ${
          isDarkMode ? "bg-[#171717] border-[#262626]" : "bg-[#FFFFFF] border-[#E5E5E5]"
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div className={`flex-1 h-px mx-8 relative ${
              isDarkMode ? "bg-[#525252]" : "bg-[#D4D4D4]"
            }`}>
            ...
            <div className="flex flex-col items-center text-center z-10">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${
                isDarkMode ? "bg-[#1F2937]" : "bg-[#DCFCE7]"
              }`}>
                <svg className={`w-8 h-8 ${
                  isDarkMode ? "text-[#10B981]" : "text-[#16A34A]"
          ...
          <div className={`mt-12 rounded-xl p-8 relative overflow-hidden ${
            ...
            <div className="relative z-10 flex items-center justify-center gap-8 flex-wrap">
              {["founder@", "team@", "support@", "sales@"].map((prefix, index) => (
                <div
                  key={index}
                  className={`rounded-lg p-4 shadow-sm border text-center min-w-[140px] ${
                    isDarkMode 
                      ? "bg-[#171717] border-[#404040] text-[#D4D4D4]" 
                      : "bg-[#FFFFFF] border-[#E5E5E5] text-[#404040]"
